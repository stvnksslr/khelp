...
### Added
- *(preferences fix + cleanup)* preferences no longer mandatory field, improved cleanup logic and included a command to clean up clusters or users orphaned from any context (by @stvnksslr)

### Contributors

* @stvnksslr
## [0.1.12](https://github.com/stvnksslr/khelp/compare/v0.1.11...v0.1.12) - 2025-12-21

### Fixed
- fix(windows builds): (by @stvnksslr)

### Contributors

* @stvnksslr
## [0.1.11](https://github.com/stvnksslr/khelp/compare/v0.1.10...v0.1.11) - 2025-12-21

### Added
- feat(tests for config): (by @stvnksslr)
- *(config handling)* blank or missing config file handling in both linux and windows (by @stvnksslr)
- feat(windows support): (by @stvnksslr)

### Contributors

* @stvnksslr
## [0.1.10](https://github.com/stvnksslr/khelp/compare/v0.1.9...v0.1.10) - 2025-12-16

### Added
- feat(export multiple contexts): (by @stvnksslr)
